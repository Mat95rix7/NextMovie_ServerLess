...
const HelmetSeo = () => {
    return (
        <Helmet>
            ...
            <meta name="keywords" content="cinéma, films, actualité cinéma, films récents, films à venir, critiques de films, bandes-annonces, TMDb, films populaires, acteurs, réalisateurs, films en salle, nouveautés cinéma, film d'action, comédies, drames, films de science-fiction, films d'horreur, critiques cinéma, cinéma 2025" />
            ...
            <meta name="twitter:card" content="https://my-cineapp.vercel.app/assets/Logo-T_7X-Wo7.jpg" />
            ...
            <meta name="twitter:image" content="https://my-cineapp.vercel.app/assets/Logo-T_7X-Wo7.jpg" />

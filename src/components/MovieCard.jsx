...
const MovieCard = ({ data }) => {
  ...
  return (
          <div className="relative group overflow-hidden min-w-[230px] max-w-[230px] rounded-lg shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer mb-8 mt-8">
            <img
            ...
            { user && (
              ...
              <div className="absolute bottom-0 p-4 w-full text-center text-white">
                <h3 className="text-xl font-bold mb-2 text-center" onClick={handleDetailsClick}>{data.title}</h3>

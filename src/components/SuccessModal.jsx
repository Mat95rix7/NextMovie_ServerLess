...
<div className="space-y-4">
  <Dialog open={showModal} onOpenChange={setShowModal}>
    <DialogContent className="w-[90%] mx-auto max-w-sm sm:max-w-md p-0 overflow-hidden bg-gradient-to-b from-white to-gray-50 rounded-lg shadow-lg">
      <div className="relative">
        ...
        <div className="relative p-6">
          ...
          <div className="w-full h-1.5 bg-gray-100 rounded-full mt-6 overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-amber-400 to-amber-500 rounded-full transition-all duration-$$3000ms$$ ease-in-out"
              style={{

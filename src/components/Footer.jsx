...
const Footer = () => {
  return (
    <footer className='bg-neutral-600 bg-opacity-35 text-neutral-400 py-2'>
      ...
      <div className="flex flex-col md:flex-row justify-center  text-sm border-t border-gray-800 mt-14 mb-5 text-center text-gray-400">
        <p>Created By <strong className='text-amber-600 pe-2'>Mat95rix7</strong></p>

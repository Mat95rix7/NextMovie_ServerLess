      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
        ...
        <div>
          <div className="text-center mt-3 mb-3 text-amber-600">Réseaux Sociaux</div>
            <div className='grid grid-cols-3 justify-center items-center text-center gap-3 text-gray-600 dark:text-gray-400'>
              <a href="https://facebook.com/mat95rix7" target="_blank" rel="noopener noreferrer">
                <FaFacebook className="inline mr-1 text-amber-600" /> Facebook
              </a>
              <a href="https://x.com/mat95rix7" target="_blank" rel="noopener noreferrer">
                <FaXTwitter className="inline mr-1 text-amber-600" /> Twitter
              </a>
              <a href="https://instagram.com/mat95rix71" target="_blank" rel="noopener noreferrer">
